...
import SnackbarContent from "~/theme/current/components/Snackbar/SnackbarContent";
import Button from "~/theme/current/components/CustomButtons/Button";
import Snackbar from "~/theme/current/components/Snackbar/Snackbar";
import Instruction from "~/theme/current/components/Instruction/Instruction";
...
import noticeModal1 from "~/theme/current/demo/assets/img/card-1.jpeg";
import noticeModal2 from "~/theme/current/demo/assets/img/card-2.jpeg";
