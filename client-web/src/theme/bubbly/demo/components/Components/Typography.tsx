...
// core components
import Quote from "~/theme/current/components/Typography/Quote";
import Muted from "~/theme/current/components/Typography/Muted";
import Primary from "~/theme/current/components/Typography/Primary";
import Info from "~/theme/current/components/Typography/Info";
import Success from "~/theme/current/components/Typography/Success";
import Warning from "~/theme/current/components/Typography/Warning";
